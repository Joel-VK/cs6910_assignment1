if __name__ == "__main__":
    ...
    parameters=do_GD(X_train,Y_train,args.optimizer,args.activation,[args.hidden_size for i in range(args.num_hiddenlayer)],
                 784,10,args.epochs,args.learning_rate,
                 0.001,args.weight_init,args.loss,args.batch_size)
